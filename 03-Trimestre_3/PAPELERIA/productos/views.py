...
class ProductoCreateView(CreateView):
    ...
    template_name = 'web_cerrada/productos/crear_producto.html'
    success_url = reverse_lazy('productos:lista_productos')

class ProductoUpdateView(UpdateView):
    model = Producto
    fields = ['titulo', 'descripcion', 'precio', 'image']
    template_name = 'web_cerrada/productos/actualizar_producto.html'
    success_url = reverse_lazy('productos:lista_productos')

class ProductoDeleteView(DeleteView):
    model = Producto
    template_name = 'web_cerrada/productos/eliminar_producto.html'
    success_url = reverse_lazy('productos:lista_productos')